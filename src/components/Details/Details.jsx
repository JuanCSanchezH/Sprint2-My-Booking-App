    ...
    <div className="details-container">
      <section className="details-container__section">
        ...
        <div className="details-container__section__line">
          <img src="https://res.cloudinary.com/ddsed1j6u/image/upload/v1698026638/Bar_srmh7y.png"/>
        </div>
      </section>
      <article className="details-container__article">
        ...
        <div className="details-container__article__flight-detail">
          <div className='details-container__article__flight-detail--ticket'>
            <span>
              <img src="https://res.cloudinary.com/ddsed1j6u/image/upload/v1697990522/Booking-Flight-Sprint/jaz3y6fjecbg7yeifz1p.svg"/>
              CA-6018 • Economy
            </span>
            <div>
              <img src="https://res.cloudinary.com/ddsed1j6u/image/upload/v1697990523/Booking-Flight-Sprint/xjartctrkacm9jmvxfc2.svg"/>
              <img src="https://res.cloudinary.com/ddsed1j6u/image/upload/v1697990523/Booking-Flight-Sprint/a5otbznzruuka3j6vfpj.svg"/>
              <img src="https://res.cloudinary.com/ddsed1j6u/image/upload/v1697990523/Booking-Flight-Sprint/vwiwnc7hgjud758k8ms9.svg"/>
            </div>
          </div>
          <div className="details-container__article__flight-detail__content">
            <div>
              <div className="details-container__article__flight-detail__content--item">
                <span>
                  <img src="https://res.cloudinary.com/ddsed1j6u/image/upload/v1697990522/Booking-Flight-Sprint/x6ubqvcvo7pt1u8r99vk.svg"/>
                  Baggage • 
                </span>
                <p>2 x 23 kg</p>
              </div>
  ...
  return (
    <div className="stop-container">
      <div className="stop-container__left-section">
        <img src="https://res.cloudinary.com/ddsed1j6u/image/upload/v1697990523/Booking-Flight-Sprint/tccmbvev7qbveceywdqt.png"/>
